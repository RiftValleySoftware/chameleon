...
loadTestMap.prototype.displayMeetingMarkers = function() {
    if ( this.m_main_map && this.m_main_map.getBounds() ) {
        ...
        if (this.m_main_map.circle_overlay) {
            this.m_main_map.circle_overlay.setMap(null);
        ...
        var circle_options =   {
                        ...
                        'fillColor': "#999",
                        'radius': parseFloat(this.m_main_map.circleRadius),
                        'fillOpacity': 0.25,
                        'strokeOpacity': 0.0,
                        'map': this.m_main_map,
                        'clickable': false
        ...
        this.m_main_map.circle_overlay = new google.maps.Circle(circle_options);
...
loadTestMap.prototype.makeRequest = function(in_long, in_lat, in_radius_in_m) {
    var uri = 'OMFGWTFDudeMapTest.php?resolve_query=' + in_long.toString() + ',' + in_lat.toString() + ',' + (in_radius_in_m / 1000.0);
...
loadTestMap.prototype.loadDBCallback = function (   in_response_object, ///< The HTTPRequest response object.
    ...
    this.m_current_task = null;
    document.getElementById('chill-dude').style.display = 'none';
    in_context.loadMap();
};
